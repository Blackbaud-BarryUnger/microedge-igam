...
namespace MicroEdge
{
	...
	/// </summary>
	/// <example>
	/// Validate an array of email addresses with the emaillib.EmailSyntaxValidator class.
	/// <code>
	/// string[]             emails;
	...
	{
		private readonly bool _syntaxvalid;
		private string _account, _domain;
		private readonly string _inputemail;
		...
		public static bool Valid(string email, bool tlDrequired)
		{
			...
			EmailSyntaxValidator v = new EmailSyntaxValidator(email, tlDrequired);
		...
		public EmailSyntaxValidator(string email, bool tlDrequired)
		{
			...
			string tmpmail = RemoveBrackets(email);
		...
		private bool DomainValid(bool tlDrequired)
		{
			...
			bool valid = re.IsMatch(emaildomain);
